...
INSERT INTO filmes (titulo, diretor, estudio, genero, ano_lancamento, bilheteria)
VALUES

    ('Avatar', 'James Cameron', '20th Century Fox', 'Ficção Científica', 2009, 2923710708),
    ('Avengers: Endgame', 'Anthony e Joe Russo', 'Marvel Studios', 'Ação', 2019, 2799439100),
    ...
    ('Avengers: Infinity War', 'Anthony e Joe Russo', 'Marvel Studios', 'Ação', 2018, 2052415039),
    ('Spider-Man: No Way Home', 'Jon Watts', 'Columbia Pictures/Marvel Studios', 'Ação', 2021, 1921426073),
    ...
    ('The Avengers', 'Joss Whedon', 'Marvel Studios', 'Ação', 2012, 1520538536),
    ...
    ('Avengers: Age of Ultron', 'Joss Whedon', 'Marvel Studios', 'Ação', 2015, 1405018048),
    ('The Super Mario Bros. Movie', 'Aaron Horvath e Michael Jelenic', 'Illumination Entertainment/Nintendo', 'Animação', 2023, 1360847665),
    ('Black Panther', 'Ryan Coogler', 'Marvel Studios', 'Ação', 2018, 1349926083),
